...
public:
   ...
   Persona( int = 0, string = "", string = "", string = "", string = "", string = "", string = "", string = "", string = "", string = "", string = "");

   // Funciones para obtener el ID
   void establecerCUI( int );
   int obtenerNumeroCUI() const;
   ...
   void establecerCodFacultad( string );
