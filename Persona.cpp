...
string Persoba:: obtenerCarrera () const
{
    return carrera;
}
...
void Persona::actualizarRegistro( fstream &actualizarArchivo )
{
   ...
   int numeroId = obtenerCUI( "Escriba el CUI del alumno a modificar" );
   ...
   mostrarLinea( cout, alumno );
    ...
    switch(choice)
    {
        ...
        case 4:
            ...
            cin >> cambioFacultad;
            empleado.establecerFacultad( cambioFacultad );}
            break;
        case 5:
            {cout << "Ingrese la nueva sede: "<<endl;
            string cambioSede;
            cin >> cambioSede;
            empleado.establecerSede( cambioSede );}
            break;
        case 6:
            {cout << "Ingrese la nueva Carrera: "<<endl;
            string cambioCarrera;
            cin >> cambioCarrera;
            empleado.establecerCarrera( cambioCarrera );}
            break;
        case 7:
...
void Persona::nuevoRegistro( fstream &insertarEnArchivo )
{
   ...
   int numeroCUI = obtenerCUI( "Ingrese el CUI del nuevo Alumno: " );
...
void Persona::eliminarRegistro( fstream &eliminarDeArchivo )
{
   ...
   int numeroCUI = obtenerCUI( "Escriba el CUI del alumno a eliminar" );
   ...
   if ( alumno.obtenerNumeroCUI() != 0 ) {
      ...
      cout << "El alumno con CUI #" << CUI << " eliminado.\n";
...
void Persona::consultarRegistro( fstream &leerDeArchivo )
{
   ...
   while ( !leerDeArchivo.eof() ) {
      ...
      // escribir un registro individual en el archivo de texto
      if ( empleado.obtenerNumeroCUI() != 0 )
